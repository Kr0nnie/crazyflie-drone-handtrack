#Same mode as number 2, but added cvimshow to display the tracking. But did not work at all initially. 
#Thus we added timesleep (0.1), worked, for some reason. maybe hardware limitations?
