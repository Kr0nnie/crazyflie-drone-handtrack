                ...
                while True:
                    ...
                    if left_hand:
                        ...
                        if left_fingers_count == 1:
                            ...
                            drone_selection = 'fb'
                        elif left_fingers_count == 4:
                            drone_selection = 'inverse'
                    ...
                    if right_hand and drone_selection:
                        ...
                        if right_fingers_count == 1:
                            ...
                            if drone_selection in ['fb']:
                                mc1.back(0.01, velocity=0.5)
                                print('Drone 1: Moving Back')
                        ...
                        #RIGHT
                            ...
                            #FRONT/BACK
                            if drone_selection in ['fb']:
                                mc2.forward(0.01, velocity=0.5)
                                print('Drone 2: Moving foward')
