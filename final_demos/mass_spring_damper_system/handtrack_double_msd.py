# Double mass spring damer system
...
while True:
    ...
    # Stuff on top
    cv2.putText(img, f'Mass Position 1: {mass_position_1:.2f}', (10, 25), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0, 0, 0), 2)
    cv2.putText(img, f'Mass Position 2: {mass_position_2:.2f}', (10, 50), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0, 0, 0), 2)
    cv2.putText(img, f'Hand Grabbed: {hand_grabbed}', (10, 75), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0, 0, 0), 2)
