...
# Variables to track mass positions
mass_position_1 = 0.0
mass_velocity_1 = 0.0
mass_position_2 = mass_position_1 - 0.5
mass_velocity_2 = 0.0
hand_grabbed = False
...
def simulate_system_1(t, y):
    dydt = [
        y[2],
        y[3],
        -k1/m1*y[0] - b1/m1*y[2] + k2/m1*(y[1]-y[0]) + b2/m1*(y[3]-y[2]),
...
while True:
    ...
    if hands:
        ...
        if fingers == [0, 0, 0, 0, 0]:  # All fingers down
            hand_grabbed = True
            wrist = lmList[0]
            mass_position_1 = (wrist[0] - center_x) / 300  # Centering and scaling position
            mass_velocity_1 = 0
            mass_position_2 = mass_position_1  # Assuming mass 2 follows mass 1 
            mass_velocity_2 = 0
