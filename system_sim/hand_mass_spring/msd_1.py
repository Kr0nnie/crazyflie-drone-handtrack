...
def main():
    ...
    # Initialize mass-spring system simulation
        ...
        with MotionCommander(scf) as mc:
            ...
            try:
                while True:
                    ...
                    if mass_position > 0.05:
                        mc.right(0.01, velocity=3)
                    elif mass_position < -0.05:
                        mc.left(0.01, velocity=3)
